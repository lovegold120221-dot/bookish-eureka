...
async def make_call(request: Request):
    try:
        ...
        call = plivo_client.calls.create(
            ...
            answer_url=f"{telephony_host}/plivo_connect?eburon_host={eburon_host}&agent_id={agent_id}",
...
async def plivo_connect(request: Request, eburon_host: str = Query(...), agent_id: str = Query(...)):
    try:
