...
2. Eburon server: for creating and handling agents 
...
```bash
docker compose up -d eburon-app twilio-app
# or
docker compose up -d eburon-app plivo-app
```
...
Go to the [Eburon examples](https://examples.bolna.dev/) to try out sample agents.
