...
from eburon.agent_types.graph_agent import GraphAgent, _DETERMINISTIC_REASONING_PREFIX
...
def _make_agent(config_overrides=None):
    ...
    with patch('eburon.agent_types.graph_agent.OpenAI', return_value=mock_openai_client), \
         patch('eburon.agent_types.graph_agent.SUPPORTED_LLM_PROVIDERS', {'openai': mock_openai_llm_cls}), \
         patch('eburon.agent_types.graph_agent.OpenAiLLM', return_value=MagicMock()):
