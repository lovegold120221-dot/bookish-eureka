from .synthesizer import (
    ...
    PixaSynthesizer,
    KokoroSynthesizer,
    OllamaTTSSynthesizer,
    EburonEdgeSynthesizer,
)
...
from .llms import OpenAiLLM, LiteLLM, AzureLLM, GeminiLLM, OllamaLLM
...
SUPPORTED_SYNTHESIZER_MODELS = {
    ...
    SynthesizerProvider.KOKORO.value: KokoroSynthesizer,
    SynthesizerProvider.OLLAMA_TTS.value: OllamaTTSSynthesizer,
    SynthesizerProvider.EBURON_EDGE.value: EburonEdgeSynthesizer,
}
...
SUPPORTED_TRANSCRIBER_PROVIDERS = {
    ...
    TranscriberProvider.WHISPER.value: WhisperTranscriber,
    TranscriberProvider.OLLAMA_STT.value: OllamaSTTTranscriber,
}
...
SUPPORTED_LLM_PROVIDERS = {
    ...
    LLMProvider.OLLAMA.value: OllamaLLM,
    LLMProvider.OLLAMA_CLOUD.value: OllamaLLM,
